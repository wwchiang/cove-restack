...
plotModule.controller("colonyPlotController", ['$scope', '$http',  function(scope, http) {
    ...
    //-- Run initialization
    // The initialData is a promise object.
    scope.reqData = http.get('/mice.txt');
        ...
        link: function(scope, element, attrs) {
            ...
            scope.reqData.then( 
                function success(data) {
                    //create_initial_view( scope.initialize(data) );
                    scope.output = data;
                }, 
                function error(msg) {
                    console.error(msg);
